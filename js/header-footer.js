...
<div>
    <ul class="header-list">
        ...
        <li class="und2">Our Worlds</li>
        <li class="und3">Experiences</li>
        <li class="und4">Gallery</li>
...
<div class="footer-lists">
    <ul class="list1">
        ...
        <a class="mail" href="mailto:mail@discoverylandco.com"><li class="ele">mail@discoverylandoco.com</li></a>
        
    </ul>
    <div class="inner-lists">
        <ul class="list2">
            <li class="ele under1">About DLC</li>
            <li class="ele under2">Our Worlds</li>
            <li class="ele under3">Experiences</li>
            <li class="ele under4">Gallery</li>
